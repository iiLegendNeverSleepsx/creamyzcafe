...
module.exports.run = async (bot, message, args) => {
    ...
    if (allowedid.includes(message.author.id)) {
	    bot.user.setAvatar(args[0]).then(() => {message.reply(`My new avatar is now **${args[0]}**!`); bot.guilds.get('613883505675599872').channels.get('710194830126350461').send(`My avatar has been changed to (URL) **${args[0]}** by **${message.author.tag}**.`)})
